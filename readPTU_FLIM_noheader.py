# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 13:22:00 2022
...
#             num_tcspc_channel    = floor(sync_rate/tcspc_bin_resolution)+1
        ...
        print('detectors')
        print(num_of_detectors)
        
        num_tcspc_channel    = np.unique(tcspc).size
        print('tcspc bins')
        print(num_tcspc_channel)
        ...
        StartSyncVal    = sync[np.where(special == LineStartMarker)]
        EndSyncVal    = sync[np.where(special == LineStopMarker)]
        
        num_of_Frames   = FrameSyncVal.size
        num_of_start   = StartSyncVal.size
        num_of_end   = EndSyncVal.size
        print('frames')
        print(num_of_Frames)
        print('starts')
        print(num_of_start)
        ...
        syncPulsesPerLine = np.floor(np.mean(L2[10:20] - L1[10:20]))
        
        #syncPulsesPerLine = 44000
        
        print('syncs per line')
        print(syncPulsesPerLine)
...
class PTUreader():
    ...
    def __init__(self, filename, print_header_data = False):
       ...
       # self._ptu_read_head(self.ptu_data_string) # i will comment this bit out
...
#                 print(tagName, tagValue)
    ...
    def _ptu_read_raw_data(self):
        ...
        record_type = self.rec_type_r[66311]

        #num_T3records = self.head['TTResult_NumberOfRecords']
        
        num_T3records = 15672593 #this needs to be changed, maybe read the file size and get the amount of records from that?
        ...
        t3records = np.frombuffer(self.ptu_data_string, dtype='uint32', count=-1, offset=0)
        ...
        if record_type == 'rtPicoHarpT3':
            ...
            #0 000000 100000000000000 0011111110 overflow 
            #1 110111 100000000000000 0000010000
            
            
            #1 101110 101010111000011 0100000110
            #1 110100 000000000000000 0010000100
    ...
    def get_flim_data_stack(self): 
        ...
        # Check
            ...
            header_variables  = np.array([1,1,1,1,1,1,1,1])
        ...
        if flim_data_stack.ndim == 4:
            ...
            intensity_image      = tmp_intensity_image
